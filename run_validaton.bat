...
class AutoValidator:
    ...
    def download_mrds(self):
        ...
        try:
            ...
            print(f"[{self.timestamp()}] [OK] MRDS loaded: {len(mrds):,} sites")
            return True
            
        except Exception as e:
            print(f"[{self.timestamp()}] [ERROR] MRDS download failed: {e}")
    ...
    def mrds_fallback(self):
        ...
        if cache_file.exists():
            ...
            print(f"[{self.timestamp()}] [OK] Loaded cached MRDS")
            return True
        else:
            print(f"[{self.timestamp()}] [WARNING] Using minimal validation set")
    ...
    def download_usmin(self):
        ...
        try:
            ...
            print(f"[{self.timestamp()}] [OK] USMIN loaded: {len(usmin):,} sites")
            return True
            
        except Exception as e:
            print(f"[{self.timestamp()}] [WARNING] USMIN download failed (non-critical): {e}")
            return False
...
'''
        ...
        print(f"[{self.timestamp()}] [OK] KML saved: {kml_file}")
    ...
    def create_visualizations(self):
        ...
        print(f"[{self.timestamp()}] [OK] Plots saved: {plot_file}")
    ...
    def generate_report(self):
        ...
        print(f"[{self.timestamp()}] [OK] Report saved: {report_file}")
        return report_file
    ...
    def run_full_validation(self):
        ...
        print(f"[{self.timestamp()}] [OK] Enhanced targets saved: {enhanced_targets_file}")
